        ...
        public async Task<IActionResult> GetRoot([FromHeader(Name = "Accept")] string mediaType)
        {
            if (mediaType.Contains("application/vnd.lotocum.apiroot"))
            {
                var list = new List<Link>()
                {
                    ...
                    new Link()
                    {
                        Href = _linkGenerator.GetUriByName(HttpContext, nameof(SansTopuController.GetOneNumbersArrayByIdForSansTopuAsync), new{}) + "/id",
                        Relation = "sanstopu",
                        Method = "GET"
                    },
                    new Link()
                    {
                        Href = _linkGenerator.GetUriByName(HttpContext, nameof(WinningNumbersController.GetOneWinningNumbersAsync), new{}) + "/id",
                        Relation = "winningnumbers",
                        Method = "GET"
                    },
                    new Link()
                    {
                        Href = _linkGenerator.GetUriByName(HttpContext, nameof(AboutUsController.GetOneAboutUsAsync), new{}) + "/id",
                        Relation = "aboutus",
                        Method = "GET"
                    },
                    new Link()
